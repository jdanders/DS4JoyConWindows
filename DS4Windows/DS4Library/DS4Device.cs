    ...
    public class DS4Device
    {
        ...
        private unsafe void performDs4Input()
        {
            unchecked
            {
                ...
                while (!exitInputThread)
                {
                    ...
                    if (conType == ConnectionType.BT && joyType != BTType.JOYCON && btInputReport[0] != 0x11 && (this.featureSet & VidPidFeatureSet.OnlyInputData0x01) == 0)
                    {
        ...
        private unsafe void sendOutputReport(bool synchronous, bool force = false, bool quitOutputThreadOnError = true)
        {
            ...
            lock (outReportBuffer)
            {
                ...
                else if (usingBT && (this.featureSet & VidPidFeatureSet.OnlyOutputData0x05) == 0)
                {
